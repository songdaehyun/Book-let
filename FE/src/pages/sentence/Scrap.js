...
import ReturnNavigationBar from "../../components/common/ReturnNavigationBar";

import LoopyImg from "../../assets/images/dummy/loopy-img.png";
import { Container } from "../../styles/common/ContainingsStyle";
import PreviewProfile from "../../components/feed/post/PreviewProfile";
import PostPreview from "../../components/feed/post/PostPreview";
import ScrapHeading from "../../components/feed/post/ScrapHeading";
			...
			<Container paddingTop="56" paddingLeft="16" paddingRight="16">
				...
				{posts.map((post) => (
					<>
						...
						/>
						<PostPreview key={post.id} post={post} isMy={false} />
					</>
				))}
			</Container>
		</>
